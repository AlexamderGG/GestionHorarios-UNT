 ...
 */
router.get('/:id/horario-lectivo', authenticate, DocenteAuthController.getHorarioLectivo);
router.get('/:id/horario-no-lectivo' , authenticate, DocenteAuthController.getHorarioNoLectivo);
